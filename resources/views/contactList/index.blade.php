                ...
                <table class="min-w-full bg-white">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        @foreach ($contactLists as $contactList)
                            <tr>
                                <td><input type="checkbox" class="contact-checkbox" value="{{ $contactList->id }}">
                                </td>
                                <td class="whitespace-nowrap px-6 py-4">
                                    {{ $contactList->created_at->format('Y-m-d') }}
                                </td>
            ...
            <div id="mass-edit-form-container"
                ...
                <div class="relative w-full max-w-sm rounded-lg bg-white p-6 shadow-lg">
                    ...
                    <form id="mass-edit-form" method="POST" action="{{ route('contacts.mass_edit') }}">
                        ...
                        <button type="submit"
                            class="mt-3 rounded-lg bg-blue-600 px-3 py-1 text-white hover:bg-blue-700">Mass
                            Edit</button>
                    </form>
                </div>
            </div>
